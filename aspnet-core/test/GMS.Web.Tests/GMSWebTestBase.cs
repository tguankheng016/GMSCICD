...
{
    public abstract class GMSWebTestBase : AbpAspNetCoreIntegratedTestBase<Startup>
    {
        protected static readonly Lazy<string> ContentRootFolder;

        static GMSWebTestBase()
        {
        ...
        protected override IWebHostBuilder CreateWebHostBuilder()
        {
            return base
                ...
                .UseSetting(WebHostDefaults.ApplicationKey, typeof(GMSWebMvcModule).Assembly.FullName);
        }
        ...
        {
            using (var context = IocManager.Resolve<GMSDbContext>())
            {
                action(context);
                context.SaveChanges();
            }
        ...
        protected async Task UsingDbContextAsync(Func<GMSDbContext, Task> action)
        {
            using (var context = IocManager.Resolve<GMSDbContext>())
            {
        ...
        protected async Task<T> UsingDbContextAsync<T>(Func<GMSDbContext, Task<T>> func)
        {
            T result;
